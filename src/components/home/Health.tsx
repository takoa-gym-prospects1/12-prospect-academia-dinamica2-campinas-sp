...
// ... (HealthText and BenefitCard remain unchanged) ...

// ... (SliderWrapper, ComparisonImage, BeforeImageWrapper, Handle remain unchanged) ...
                    ...
                    >
                        ...
                        <BeforeImageWrapper $width={sliderPosition}>
                            <img
                                ...
                                loading="lazy"
                                style={{
                                    width: containerRef.current ? containerRef.current.clientWidth : '600px',
                                    height: '100%',
                                    objectFit: 'cover',
                                    maxWidth: 'none'
                                }}
